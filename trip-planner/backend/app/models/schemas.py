...
class WeatherInfo(BaseModel):
    ...
    dayweather: str = Field(default="", description="白天天气")
    nightweather: str = Field(default="", description="夜间天气")
    daytemp: Union[int, str] = Field(default=0, description="白天温度")
    nighttemp: Union[int, str] = Field(default=0, description="夜间温度")
    daywind: str = Field(default="", description="白天风向")
    daypower: str = Field(default="", description="白天风力")
    nightwind: str = Field(default="", description="夜间风向")
    nightpower: str = Field(default="", description="夜间风力")
...
class POIDetailInfo(BaseModel):
    ...
    address: str = Field(..., description="地址")
    business_area: Optional[str] = Field(default=None, description="商圈")
    city: str = Field(..., description="城市")
    type: str = Field(..., description="类型")
    alias: Optional[str] = Field(default=None, description="别名")
    photo: str = Field(default="", description="图片URL")
    cost: Optional[str] = Field(default=None, description="费用")
    opentime2: Optional[str] = Field(default=None, description="营业时间")
    level: str = Field(default="", description="等级")
    rating: Optional[str] = Field(default=None, description="评分")
    open_time: Optional[str] = Field(default=None, description="开放时间")
    ticker_ordering: Optional[str] = Field(default=None, description="排序优先级")
...
class POIDetailResponse(BaseModel):
    ...
    success: bool
    message: str
    data: Optional[POIDetailInfo] = None
...
class PathInfo(BaseModel):
    """路线具体信息"""
    instruction: str = Field(..., description="路线指令")
    road: str = Field(..., description="道路名称")
    distance: float = Field(..., description="距离(米)")
    orientation: str = Field(..., description="方向")
...
class RouteInfo(BaseModel):
    ...
    distance: float = Field(..., description="距离(米)")
    duration: int = Field(..., description="时间(秒)")
    steps: List[PathInfo] = Field(default=[], description="路线步骤")
...
class PhotoInfo(BaseModel):
    ...
    thumb: str = Field(..., description="缩略图URL")
    description: str = Field(default="", description="图片描述")
    photographer: str = Field(default="", description="摄影师")
