...
class Settings(BaseSettings):
    ...
    openai_api_key: str = os.getenv("LLM_API_KEY") or os.getenv("OPENAI_API_KEY") or ""
    openai_base_url: str = os.getenv("LLM_BASE_URL") or ""
    openai_model: str = os.getenv("LLM_MODEL_ID") or ""
